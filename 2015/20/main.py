def main() -> None:
    ...
    house_presents_part1: [int] = get_house_presents(max_house_number_part1, multiplier_part1, max_house_number_part1)
    house_presents_part2: [int] = get_house_presents(max_house_number_part2, multiplier_part2, 50)

    print_house_number(house_presents_part1, presents_target)
    print_house_number(house_presents_part2, presents_target)


def get_house_presents(max_house_number: int, multiplier: int, house_limit: int) -> [int]:
...
def print_house_number(house_presents: [int], presents_target: int) -> None:
